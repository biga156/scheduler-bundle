...
#[AsCommand(
    name: 'caeligo:scheduler:enable',
    description: 'Enable a scheduled task',
)]
class SchedulerEnableCommand extends Command
{
    ...
    {
        $this
            ->addArgument('command-name', InputArgument::REQUIRED, 'The command name to enable')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->stateManager->setEnabled($commandName, true);
        $io->success(\sprintf('Task "%s" has been enabled.', $commandName));
